...
namespace LibVLCSharp.Maui.Shared
{
    ...
    public partial class PlaybackControls : TemplatedView
    {
        ...
        public PlaybackControls()
        {
            ...
            Manager = new MediaPlayerElementManager(new Maui.Shared.Dispatcher(), new DisplayInformation(), new DisplayRequest());
        ...
        {
            Application.Current!.Dispatcher.DispatchAsync(() => ErrorMessage = string.Format(ResourceManager.GetString(nameof(Strings.ErrorWithMedia))!, Manager.Get<StateManager>().MediaResourceLocator));
        }
        ...
        protected virtual void ShowErrorMessageBox(Exception ex)
        {
            ...
            Application.Current!.Dispatcher.DispatchAsync(() => this.FindAncestor<Page?>()?.DisplayAlert(error, ex?.GetBaseException().Message ?? error,
